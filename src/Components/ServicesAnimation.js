...
const ServicesAnimation = () => {
  ...
  return (
    <div
      className="bg-[#fdf9f4] py-12 px-4 w-screen overflow-x-hidden overflow-y-visible z-0 "
      style={{
        fontFamily: "'Inter', sans-serif",
      }}
    >
      ...
      <div
        className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-12 gap-x-8 justify-center items-center mx-auto"
        style={{ maxWidth: "900px", margin: "0 auto" }}
      >
        {services.map((service, index) => (
          <motion.div
          ...
          >
            <motion.img
              ...
              initial="initial"
            />
            <h3 className="text-2xl lg:text-2xl font-medium text-gray-500 leading-relaxed group-hover:text-gray-500  transition duration-300">
              {service.title}
            </h3>
          </motion.div>
        ))}
